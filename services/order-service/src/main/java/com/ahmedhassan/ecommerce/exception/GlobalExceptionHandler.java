...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleCustomerNotFoundException(
            @NonNull CustomerNotFoundException ex,
            @NonNull HttpServletRequest request
    ) {
    ...
    public ResponseEntity<ErrorResponse> handleOrderNotFoundException(
            @NonNull OrderNotFoundException ex,
            @NonNull HttpServletRequest request
    ) {
        return buildErrorResponseEntity(HttpStatus.NOT_FOUND, ex, request);
    }

    @ExceptionHandler(ProductPurchaseNotSuccessfulException.class)
    public ResponseEntity<ErrorResponse> handleProductPurchaseNotSuccessfulException(
            @NonNull ProductPurchaseNotSuccessfulException ex,
            @NonNull HttpServletRequest request
    ) {
